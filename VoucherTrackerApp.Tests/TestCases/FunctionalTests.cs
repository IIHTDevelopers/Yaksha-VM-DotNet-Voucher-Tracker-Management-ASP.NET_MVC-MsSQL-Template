...
namespace VoucherTrackerApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Voucher()
        {
            //Arrange
            var res = false;
            ...
            try
            {
                 fitnnesstrackerservice.Setup(repos => repos.GetVouchers()).Returns(voucherList);
                var result =  _voucherTrackerService.GetVouchers();
                //Assertion
                if (result != null)
                {
                    res = true;
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Voucher_ById()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Voucher()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Voucher()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                fitnnesstrackerservice.Setup(repos => repos.DeleteVoucher(_voucher.VoucherId)).Returns(1);
                var result=_voucherTrackerService.DeleteVoucher(_voucher.VoucherId);
